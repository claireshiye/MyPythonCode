...
def find_mtb_bss_beginning_time(star_id, z, filestring, t, BSEEXEC='/Users/sourav/research/sources/bse/bse/bse'):
    """finds the binary properties"""
...
def just_print(total, total_core, directorystring, writefilename):
    ...
    2. run just_#print after supplying the file this line needs to be #printed to and the directory specifying the model.  
    """
