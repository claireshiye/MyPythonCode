...
class LISA():
    ...
    def __init__(self, Tobs=4*YEAR, Larm=2.5e9, NC=2, transfer_file='/projects/b1095/syr904/MyCodes/PythonCodes/eXtremeGravityInstitute-LISA_Sensitivity-defe1d7/R.txt'):
        """
