...
def snr(m1, m2, a0, e0, d, n_max, noise_interp, t_final):
	...
	t, a, e = t_inspiral_2(a0/1.5e11,e0,m1,m2,t_flag=t_final, array=1, LIGO=0) # Calculates a, e evolution until t_final. t_final = 10 years or t_merger
